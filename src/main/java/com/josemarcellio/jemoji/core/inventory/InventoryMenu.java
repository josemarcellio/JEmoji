...
public class InventoryMenu implements PluginInstance {
        ...
        for (String string : file.getConfigurationSection ( "emoji" ).getKeys ( false )) {
            ...
            if(split[0].equals("head")) {
                ...
                if (itemStack != null) {
                    ...
                    skullMeta.setLore ( loree.stream ().map ( Utility::getColor ).collect ( Collectors.toList () ) );
                ...
                if (itemStack != null) {
                    ...
                    itemMeta.setLore ( loree.stream ().map ( Utility::getColor ).collect ( Collectors.toList () ) );
